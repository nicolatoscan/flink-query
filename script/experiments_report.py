...
# note
usage = "python3 <script_name.py> <jar_name>"
...
def summarize_exp(job_alias, job_file, exe_time):
    # different devices
    # get sum_file_name
    unique_exp_name = job_alias
    summ_file_name = exp_results_local_dir + "/" + exp_results_summ_file
    ...
    latency_hists = []
    success_time = 0
    latency_throughput_file_name = "/mnt/d/Knowledge_Base/flink-query/metrics_logs/latency_throughput.txt"
    ...
    # input_rates = stats_input_rates
    # nums_of_data = stats_nums_of_data
    ...
    #         unique_exp_job_name = job_file + "-" + str(input_rate) + "-" + str(num_of_data) + "-t" + str(t)
...
def main():
    ...
    #     exit(-1)
    summarize_exp(job_alias, args.jar_name, 2)
