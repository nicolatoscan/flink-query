 ...
 */
 ...
 @Documentation.SuffixOption(value = "reporter")
 public class PrometheusPushGatewayReporterOptions {
     ...
     public static final ConfigOption<String> FILTER_METRICS =
             ConfigOptions.key("filter_metrics")
                    .stringType()
                     .defaultValue("")
                     .withDescription(
                             Description.builder()
                                     .text(
                                             "Only the specified metrics are pushed to the pushGateway.",
                                             TextElement.code("v1,v2,v3"))
                                     .build());
 }